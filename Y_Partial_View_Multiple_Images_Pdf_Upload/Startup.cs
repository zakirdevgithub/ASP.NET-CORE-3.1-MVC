...
using Y_Partial_View_Multiple_Images_Pdf_Upload.Station;
...
namespace Y_Partial_View_Multiple_Images_Pdf_Upload
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataContext>(options => options.UseSqlServer("Server=DESKTOP-E7O9U9N; Database=UploadMultipleImage; Trusted_Connection=True; MultipleActiveResultSets=True;"));
